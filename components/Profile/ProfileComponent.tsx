...
const ProfileComponent: React.FC<UserType> = ({ user}) => {
      ...
      <main className="max-w-7xl mx-auto">
        <div className="px-4 py-6 sm:px-0">
          <div className="border-4 border-border rounded-lg h-96 mb-6 relative">
            <img
              src={user.cover || "/placeholder.svg?height=384&width=1024"}
              alt="Cover"
            ...
            <CardContent>
              <dl className="divide-y divide-border">
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                  ...
                  <dd className="mt-1 text-sm sm:mt-0 sm:col-span-2">{user?.location || "--"}</dd>
                </div>
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                  <dt className="text-sm font-medium text-muted-foreground flex items-center">
                  ...
                  <dd className="mt-1 text-sm sm:mt-0 sm:col-span-2">{user?.occupation || "--"}</dd>
                </div>
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                  <dt className="text-sm font-medium text-muted-foreground flex items-center">
                  ...
                  <dd className="mt-1 text-sm sm:mt-0 sm:col-span-2">{formatTimestamp(user?.createdAt)}</dd>
                </div>
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                  <dt className="text-sm font-medium text-muted-foreground flex items-center">
